...
void print_details(int width, int height, int n_ch, int n_clus, int n_iters, double sse, double exec_time);
...
int main(int argc, char **argv)
{
    ...
    print_details(width, height, n_ch, n_clus, n_iters, sse, exec_time);
